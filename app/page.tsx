...
export default function Home() {
  ...
  const faq = [
    ...
    { question: "Показываются ли цены?", answer: "Опубликованные тарифы на период 01.07–25.08.2026.", source: sunriseConfig.officialLinks.prices, status: "Опубликовано на странице стоимости · 13.08.2026" },
